...
ARTICLE_SPECIFIC_PROMPTS = {
    ...
    "extreme-droite-francaise-socialiste-ailleurs": "Giant world map split into political zones with France glowing bright red in center labeled 45% taxes, surrounded by countries in cool blue showing much lower percentages: USA 26%, Japan 33%, Africa 16%, Singapore 15%; French political spectrum shown as tiny sliver on global scale, with RN party positioned where American Democrats would be; Bernie Sanders figure on far left of US spectrum aligned with French center-right; Marianne statue holding both Sécurité Sociale card and vacation calendar while American worker looks on confused; African worker with no safety net visible; historic timeline at bottom showing 1789 Revolution, 1936 Front Populaire, 1945 CNR creating the French exception; Rousseau and Croizat as philosophical guardian angels above France; warm social-democratic golds for France contrasting with cold free-market blues elsewhere",
}
