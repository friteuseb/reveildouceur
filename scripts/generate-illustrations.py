...
ARTICLE_SPECIFIC_PROMPTS = {
    ...
    "pourquoi-on-narrive-plus-a-etre-en-couple": "Two lonely silhouettes facing each other but separated by infinite wall of glowing smartphone screens showing dating app profiles scrolling endlessly, paradox of choice visualization, each screen shows a different potential partner face but creates barrier not bridge, Tinder-like swipe gestures frozen in mid-air, heart symbols floating but never connecting, one figure reaching through screens while other swipes away, urban apartment windows in background each containing solitary figure, comparison thought bubbles showing idealized partners versus reality, shattered hourglass with sand forming '45%' divorce statistic, wedding rings rusting on ground, modern loneliness despite infinite connections, warm human tones versus cold blue screen light",
