<footer class="footer">
  <div class="container footer__inner">
    <div class="footer__brand-section">
      <div class="footer__brand">Réveil Douceur</div>
      <p class="footer__desc">
        Un espace de réflexion basé sur des faits et des études sourcées.
        Questionnez. Vérifiez. Pensez par vous-même.
      </p>
    </div>
    ...
    <div>
      ...
      <ul class="footer__links">
        <li><a href="/" class="footer__link">Articles</a></li>
        <li><a href="/miroir-pensee.html" class="footer__link">Pensée Libre</a></li>
        <li><a href="/miroir-croyances.html" class="footer__link">Croyances Invisibles</a></li>
  ...
  <div class="container footer__bottom">
    <p>&copy; <?= date('Y') ?> Réveil Douceur. Tous droits réservés.</p>
  </div>
</footer>
